...
class App:
    ...
    def start_up(self):
        ...
        self.coins = coins_renderer(
            MAZE_COORDINATES_PATH,
            self.canvas,
            self.coins_removed,
            self.state
        )
    ...
    def configure_controls(self):
        ...
        self.canvas.bind(self.settings['left'], move_left)
        self.canvas.bind(self.settings['right'], move_right)
        self.canvas.bind(self.settings['up'], move_up)
    ...
    def display_game_over_menu(self):
        ...
        self.image = self.game_over.create_image(
            WINDOW_WIDTH // 2 + 20,
            320,
            image=self.img,
            anchor=CENTER
        ...
        error_text = self.game_over.create_text(
            GAME_OVER_SCORE_X,
            ERROR_MESSAGE_Y,
            font=('Arial', 30, 'bold'),
            fill='red'
    ...
    def hide_window(self):
        ...
        if not self.hideWindow:
            ...
            self.boss = self.hideCanvas.create_image(
                0,
                -25,
